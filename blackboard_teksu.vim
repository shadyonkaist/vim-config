...
let g:colors_name="blackboard_teksu"
...
hi Directory    ctermfg=81 guifg=lightgray 
...
hi Statement    ctermfg=117  guifg=117
...
hi Todo     ctermfg=black guifg=black ctermbg=yellow
...
hi htmlEndTag ctermfg=32  guifg=32
...
hi htmlTag  ctermfg=32  guifg=32
hi htmlTagName  ctermfg=32  guifg=32
...
"hi htmlH1 ctermfg=white  guifg=25 cterm=bold
...
hi pythonEscape     ctermfg=252 guifg=252
hi pythonString     ctermfg=29 guifg=29
hi pythonRawString     ctermfg=29 guifg=29
hi pythonUniString     ctermfg=29 guifg=29
hi pythonUniRawString     ctermfg=29 guifg=29
hi pythonFunction     ctermfg=red guifg=red
hi pythonFuncDef     ctermfg=yellow guifg=yellow
hi pythonFuncName     ctermfg=red guifg=red cterm=bold
hi pythonDefaultAssignment  ctermfg=yellow guifg=yellow
hi pythonParamName  ctermfg=67 guifg=67
hi pythonClassDef     ctermfg=yellow guifg=yellow
hi pythonClassName     ctermfg=red guifg=red cterm=bold
hi pythonSuperclass     ctermfg=252 guifg=252
hi pythonNumber     ctermfg=252 guifg=252
hi pythonPreCondit    ctermfg=yellow  guifg=yellow

hi pythonStatement ctermfg=yellow guifg=yellow
hi pythonConditional    ctermfg=yellow  guifg=yellow
hi pythonRepeat     ctermfg=yellow  guifg=yellow
hi pythonOperator     ctermfg=yellow guifg=yellow
"hi pythonAssignment    ctermfg=yellow guifg=yellow
"hi pythonComparison    ctermfg=yellow guifg=yellow
"hi pythonArithmetic    ctermfg=yellow guifg=yellow
hi pythonDecorator      ctermfg=red guifg=red
hi pythonComment      ctermfg=239  guifg=81
hi pythonDocstring      ctermfg=81  guifg=81
hi pythonCoding      ctermfg=67  guifg=67
hi pythonRun      ctermfg=67  guifg=67

hi pythonDocTest  ctermfg=67 guifg=67
hi pythonDocTest2  ctermfg=67 guifg=67
hi pythonBuiltinFunc  ctermfg=67 guifg=67
hi pythonBuiltinObj   ctermfg=67 guifg=67
hi pythonExClass    ctermfg=67 guifg=67
hi pythonStrFormatting  ctermfg=67 guifg=67
hi pythonStrFormat	ctermfg=67 guifg=67
hi pythonStrTemplate  ctermfg=67 guifg=67
hi pythonException    ctermfg=yellow guifg=yellow

hi pythonTodo     ctermfg=black  guifg=black ctermbg=yellow
